...
const MainPage = () => {
  ...
  to their brand.</p>
        ...
        lg:pr-5  mb-10 relative xl:mt-20  place-items-center'>
           ...
           <button className='xl:hidden  border-2 px-4 py-1.5 mt-7 xl:mt-4 hover:bg-black hover:text-white'>SEE ALL</button>
        </Section>
