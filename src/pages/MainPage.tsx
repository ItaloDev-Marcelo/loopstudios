...
const MainPage = () => {
  return (
    <main className='flex flex-col items-center justify-center md:items-start xl:items-center p-2 xl:gap-5'>
        ...
        lg:pl-17 xl:my-5 '>
           ...
           <div className=' text-black text-center lg:text-left bg-white p-10
            lg:w-137.5 lg:h-88.75 relative lg:top-27 lg:right-50 lg:mb-30 xl:my-0'>
  ...
  to their brand.</p>
        ...
        <Section style='flex flex-col xl:my-5   justify-center items-center xl:items-stretch
        lg:pr-5 xl:pl-30 mb-10 relative xl:mt-20  place-items-center'>
           ...
           xl:grid-cols-4 gap-5 xl:gap-7 xl:mt-10 tb1:pl-13 bg-purple-200 p-30'>  
               {
                Data.map((data) => (
